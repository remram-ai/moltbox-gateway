...
Canonical `remram` control-plane package rooted under `the-inner-loop/`.
...
- 02 deployment orchestration, rendering, snapshot metadata, rollback, and host-tool allowlisting
...
python -m remram_dev_manager_control_pane deploy ollama
python -m remram_dev_manager_control_pane rollback dev
